...
public class TestUser {
	...
	private MockHttpSession sessionPepe, sessionAna;
	...
	void testPartida() throws Exception {
		...
		this.server.perform(requestPepe).andExpect(status().isOk());
		...
		this.server.perform(requestAna).andExpect(status().isOk());
	}
